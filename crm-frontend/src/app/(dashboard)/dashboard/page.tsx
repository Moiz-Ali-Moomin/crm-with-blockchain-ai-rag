    ...
    <div className="bg-white border border-gray-200 rounded-xl p-5">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-semibold text-gray-900">Tasks Due Today</span>
        </div>
      ...
      <div className="space-y-1">
        {MOCK_TASKS.map((task) => (
          <div
            key={task.id}
            className="flex items-start gap-3 p-3 rounded-lg hover:bg-gray-50 transition-colors duration-150 group cursor-pointer"
          >
            {/* Checkbox placeholder */}
            <div className="mt-0.5 w-4 h-4 rounded border border-gray-300 group-hover:border-blue-400 transition-colors shrink-0" />
